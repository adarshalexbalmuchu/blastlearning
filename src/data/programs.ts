...
const programsData: ProgramData[] = [
  {
    ...
    testimonials: [
      {
        name: 'A Student of Class 10 from Mumbai',
        role: 'CBSE Class 10',
        content:
          'I thought I was decent at math until the GAP Assessment showed me I was still shaky on stuff from Class 7. Once I saw exactly where I was stuck, the practice actually made sense.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
      ...
      {
        name: 'A Student of Class 10 from Bengaluru',
        role: 'CBSE Class 10',
        content:
          'I used to wait for the next tuition class to ask a doubt and forget it by then. Now I ask the AI Tutor the moment I\'m stuck, and it shows me where I went wrong instead of just handing me the answer.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
      ...
      {
        name: 'A Student of Class 10 from Chennai',
        role: 'CBSE Class 10',
        content:
          'Studying alone got boring fast. My Study Buddy and I work through the same practice set most evenings, and having someone to check in with made it a lot harder to skip a session.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
      ...
      {
        name: 'A Student of Class 10 from Pune',
        role: 'CBSE Class 10',
        content:
          'Earlier I\'d revise a chapter the night before a test and forget it a week later. Now the sessions come back to old topics right when I start forgetting them, so it\'s actually sticking this time.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
...

  {
    ...
    testimonials: [
      {
        name: 'A Student of Class 11 from Hyderabad',
        role: 'SAT Prep Pass',
        content:
          'I used to blank out in timed sections even when I knew the material. Mind Coach had me working on staying calm under a clock, not just on more practice questions, and that helped more than another mock test would have.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
      ...
      {
        name: 'A Student of Class 12 from Kolkata',
        role: 'SAT Prep Pass',
        content:
          'I used to just reread my notes before practice tests. Now I have to solve the problem first and check after, and I remember a lot more once I\'ve actually struggled with it myself.',
        before: '',
        after: '',
        metric: '',
        improvement: '',
  ...
  // Math Genius Maker entry above field-for-field, all values left blank;
  // fill in real content before linking it anywhere.
  {
    slug: 'new-program',
    name: '',
    tagline: '',
    ...
    testimonials: [
      { name: '', role: '', content: '', before: '', after: '', metric: '', improvement: '' },
      { name: '', role: '', content: '', before: '', after: '', metric: '', improvement: '' },
    ],
    faqs: [
      { q: '', a: '' },
