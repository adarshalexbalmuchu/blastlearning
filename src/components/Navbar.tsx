...
import blastLogo from '../assets/brand/blast-logo.webp';
    ...
    subMenus: [
      {
        ...
        items: [
          ...
          { label: '[New Program Name]', description: 'Placeholder — content coming soon', icon: IconBook, iconBg: 'linear-gradient(135deg,#EEF2FF 0%,#E0E7FF 100%)', iconBorder: '#C7D2FE', path: '/programs/new-program' },
              ...
              <div style={{ flex: 1, padding: '8px 0' }}>
                {visibleNavItems.map((item) => {
                  ...
                  if (item.subMenus) {
                    ...
                    return (
                      <div key={item.id}>
                        {/* Parent row — label navigates to the main page, chevron toggles the submenu */}
                        <div style={{ display: 'flex', alignItems: 'center', borderBottom: expanded ? 'none' : '1px solid #F7F7F8' }}>
                          ...
                          >
                            <ChevronDown size={16} style={{ transform: expanded ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s', color: '#8E8EA0', flexShrink: 0 }} />
                          </button>
                        </div>
                        {/* Sub-items */}
                        <AnimatePresence>
