...
function GradStudent({ color }: { color: string }) {
  return (
    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" aria-hidden="true">
      ...
      {/* ── Graduation cap — isometric top face ── */}
...
function RatingStar({ color }: { color: string }) {
  ...
  return (
    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" aria-hidden="true">
      ...
      {/* Shine stripe on badge */}
      <path d="M30 98 Q75 92 120 98 L120 84 Q75 80 30 84 Z" fill="white" opacity="0.1" />

      {/* Score text — SVG text renders with loaded fonts */}
      <text x="75" y="111" textAnchor="middle" fontFamily="Poppins, sans-serif" fontWeight="700" fontSize="20" fill="white">
        4.8 / 5
      </text>
      <text x="75" y="123" textAnchor="middle" fontFamily="Inter, sans-serif" fontWeight="500" fontSize="10" fill="white" opacity="0.72">
        Parent Satisfaction
      </text>
...
function MapPinChar({ color }: { color: string }) {
  return (
    <svg width="150" height="150" viewBox="0 0 150 150" fill="none" aria-hidden="true">
      ...
      {/* ── Dotted connection lines from center pin to satellites ── */}
...
function StatCard({ stat, index, inView, reduce }: { stat: StatItem; index: number; inView: boolean; reduce: boolean }) {
  ...
  return (
    ...
    >
      {/* Number + label — slide up on hover */}
      <motion.div
      ...
      {/* Premium illustration — springs up from below on hover */}
      <motion.div
        initial={false}
...
export default function TrustStats() {
  ...
  return (
    <section ref={ref} className="section-pad" style={{ paddingTop: '56px', paddingBottom: '64px', background: '#F7F7F8' }}>
