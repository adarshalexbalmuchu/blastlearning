...
export default function TrustStats() {
  ...
  return (
    <section ref={ref} className="section-pad" style={{ paddingTop: '72px', paddingBottom: '64px', background: '#FFFFFF', borderRadius: '20px 20px 0 0', boxShadow: '0 -8px 32px rgba(28,28,40,0.06)' }}>
