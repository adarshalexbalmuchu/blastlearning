...
export const HeroIllustration: FC<IllustrationProps> = ({ className, width = '100%', height = '100%' }) => (
  ...
  >
    ...
    {Array.from({ length: 6 }, (_, row) =>
      Array.from({ length: 8 }, (_, col) => (
        <circle
          ...
          cy={40 + row * 56}
          r="1.5"
          fill="rgba(28,28,40,0.06)"
        />
      ))
    )}

    {/* Desk surface */}
    <rect x="80" y="278" width="320" height="14" rx="7" fill="rgba(28,28,40,0.04)" stroke="#ECECF1" strokeWidth="1" />
    ...
    <line x1="350" y1="89" x2="284" y2="156" stroke="rgba(28,28,40,0.1)" strokeWidth="1" strokeDasharray="4 4" />
    <line x1="402" y1="246" x2="332" y2="246" stroke="rgba(28,28,40,0.08)" strokeWidth="1" strokeDasharray="4 4" />
  </svg>
);
