...
import step1Img from '../assets/shared/competency-based-learning.png';
import step2Img from '../assets/shared/critical-thinking.png';
...
const testimonialsRow1 = [
  ...
  { name: 'A Student of Class 10 from Bengaluru', role: 'CBSE Class 10', text: 'I used to wait for the next tuition class to ask a doubt and forget it by then. Now I ask the AI Tutor the moment I\'m stuck, and it shows me where I went wrong instead of just handing me the answer.' },
  { name: 'A Student of Class 10 from Chennai', role: 'CBSE Class 10', text: 'Studying alone got boring fast. My Study Buddy and I work through the same practice set most evenings, and having someone to check in with made it a lot harder to skip a session.' },
  { name: 'A Student of Class 11 from Hyderabad', role: 'SAT Prep Pass', text: 'I used to blank out in timed sections even when I knew the material. Mind Coach had me working on staying calm under a clock, not just on more practice questions, and that helped more than another mock test would have.' },
];
const testimonialsRow2 = [
  { name: 'A Student of Class 10 from Pune', role: 'CBSE Class 10', text: 'Earlier I\'d revise a chapter the night before a test and forget it a week later. Now the sessions come back to old topics right when I start forgetting them, so it\'s actually sticking this time.' },
      ...
      <section style={{ paddingTop: '96px', paddingBottom: '96px', background: '#FFFFFF' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto', padding: '0 24px', textAlign: 'center' }}>
          ...
          >
            ...
            <Link to="/plans" className="cta cta-pink" style={{ fontSize: '15px', fontWeight: 700, padding: '14px 40px', display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
