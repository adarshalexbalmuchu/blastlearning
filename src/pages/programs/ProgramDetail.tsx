      ...
      <section className="hero-banner-offset" style={{ paddingTop: '18px', paddingBottom: '10px', background: '#FFFFFF' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px' }}>
          ...
          >
            ...
            <span aria-hidden="true" style={{ display: 'inline-flex', alignItems: 'center', gap: 'clamp(0px, 0.35vw, 4.5px)', position: 'absolute', top: program.slug === 'math-genius' ? '16.5%' : '17%', left: 'calc(7.5% + 5px)', zIndex: 3, pointerEvents: 'none' }}>
