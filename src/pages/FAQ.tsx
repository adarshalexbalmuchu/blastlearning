...
export default function FAQ() {
  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      {/* Hero */}
      <section style={{ position: 'relative', overflow: 'hidden', background: '#FFFFFF', paddingTop: '80px', paddingBottom: '60px', borderBottom: '1px solid #ECECF1' }}>
      ...
      {/* FAQ Content */}
      <section style={{ paddingTop: '48px', paddingBottom: '96px', background: '#F7F7F8' }}>
