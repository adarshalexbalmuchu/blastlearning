...
export default function FAQ() {
  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      {/* Hero */}
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(170deg, #E0F5FC 0%, #F5FBFF 35%, #FFFFFF 100%)', paddingTop: '80px', paddingBottom: '60px', borderBottom: '1px solid #DAEEF6' }}>
      ...
      {/* FAQ Content */}
      <section style={{ paddingTop: '48px', paddingBottom: '96px', background: '#EEF9FD' }}>
