...
export default function Blog() {
  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      ...
      {/* Hero */}
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(170deg, #B8E4F5 0%, #D6F2FA 45%, #FFFFFF 100%)', borderBottom: '1px solid #DAEEF6', paddingTop: '120px', paddingBottom: '72px' }}>
      ...
      {/* Posts grid */}
      <section style={{ paddingTop: '56px', paddingBottom: '96px', background: '#D6F2FA' }}>
