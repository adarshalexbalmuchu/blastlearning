...
export default function BlogPost() {
  ...
  return (
    <div style={{ background: '#FFFFFF' }}>
      ...
      {/* Hero */}
      <section style={{ position: 'relative', overflow: 'hidden', background: 'linear-gradient(170deg, #E0F5FC 0%, #F5FBFF 35%, #FFFFFF 100%)', borderBottom: '1px solid #DAEEF6', paddingTop: '120px', paddingBottom: '56px' }}>
