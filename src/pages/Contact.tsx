                    ...
                    <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(1, 1fr)', gap: '16px' }} className="grid-cols-2-sm">
                        <div>
                          ...
                          <input type="text" name="name" required value={form.name} onChange={handleChange} placeholder="Your full name" style={inputStyle} onFocus={(e) => { e.currentTarget.style.borderColor = '#0FA8DC'; }} onBlur={(e) => { e.currentTarget.style.borderColor = '#ECECF1'; }} />
                        </div>
                        <div>
                          ...
                          <input type="email" name="email" required value={form.email} onChange={handleChange} placeholder="your@email.com" style={inputStyle} onFocus={(e) => { e.currentTarget.style.borderColor = '#0FA8DC'; }} onBlur={(e) => { e.currentTarget.style.borderColor = '#ECECF1'; }} />
                        </div>
                      </div>
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(1, 1fr)', gap: '16px' }} className="grid-cols-2-sm">
                        <div>
                          ...
                          <input type="tel" name="phone" value={form.phone} onChange={handleChange} placeholder="+91 XXXXX XXXXX" style={inputStyle} onFocus={(e) => { e.currentTarget.style.borderColor = '#0FA8DC'; }} onBlur={(e) => { e.currentTarget.style.borderColor = '#ECECF1'; }} />
                        </div>
                        <div>
                          ...
                          <select name="role" required value={form.role} onChange={handleChange} style={{ ...inputStyle, appearance: 'none' }} onFocus={(e) => { e.currentTarget.style.borderColor = '#0FA8DC'; }} onBlur={(e) => { e.currentTarget.style.borderColor = '#ECECF1'; }}>
